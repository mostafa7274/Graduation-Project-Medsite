...
<head>
    ...
    <title>MEDSITE - Admin Registration</title>
    ...
    <style>
        /* All your existing CSS styles from the login template */
        /* ... (paste all the CSS from the login template here) ... */

        /* Additional styles for registration form */
        .registration.form-peice {
            background: #fff;

            /* Slightly taller to accommodate more fields */
            margin-top: 30px;
        ...
        <section id="formHolder">
            <div class="row">
                ...
                <div class="col-sm-6 brand">
                    ...
                    <div class="heading">
                        <h2>MEDSITE <span class="admin-badge">ADMIN</span></h2>
                        <p>Administrator Registration</p>
                    </div>
                    <div class="success-msg">
                        <p>Registration Successful!</p>
                        <a href="{{ url('admin/dashboard') }}" class="profile">Go to Dashboard</a>
                    </div>
                </div>
                ...
                <div class="col-sm-6 form">
                    <!-- Registration Form -->
                    <div class="registration form-peice">
                        <form method="POST" action="{{ route('admin.dashboard.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="@error('name') hasError @enderror" name="name"
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin_key" type="text" class="@error('admin_key') hasError @enderror"
                                    name="admin_key" value="{{ old('admin_key') }}" required autocomplete="admin_key">
                                @error('admin_key')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" type="password" class="@error('password') hasError @enderror"
                            ...
                            <div class="additional-options">
                                ...
                                <a href="{{ url('admin/dashboard/login') }}" class="admin-login">
                                    {{ __('Login as Admin') }}
                                </a>
                            </div>
                        </form>
