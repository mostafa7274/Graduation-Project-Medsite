...
@section('content')
    ...
    <!-- <style>
                                                    ...
                                                    .form-control-label {
                                                        ...
                                                        z-index: 2;
                                                        background-color: transparent;
                                                        /* Ensure label background doesn't cover input */
                                                    }
                                                    ...
                                                    .form-control:not(:placeholder-shown)~.form-control-label {
                                                        ...
                                                        padding: 0 4px;
                                                        z-index: 1;
                                                        /* Ensures label is on top after focus */
                                                        border-radius: .375rem;
                                                    }
                                                    ...
                                                    .form-control {
                                                        ...
                                                        height: auto;
                                                        border-radius: .375rem;
                                                        /* Match input field rounded corners */
                                                    }
                                                    ...
                                                    /* Optional: Add styling for the focused state of input fields */
                                                    .form-control:focus {
                                                        border-color: #15616D;
                                                        /* Color to match the label background */
    ...
    <body>
        <div class="main-content">
            ...
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center"
                style="min-height: 600px; background-image: url('{{ asset('assets/welcomee/images/section1.jpg') }}'); background-size: cover; background-position: center top;">
                <!-- Mask -->
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            <h1 class="display-2 text-white">{{ "Welcome, $user->name" }}</h1>
                            <br>
                            <p class="text-white mt-0 mb-5">Your health journey starts here. With Mediste, you can
                                confidently track your medications, avoid dangerous interactions, and stay informed about
                                potential risks. <br> Whether you’re managing multiple prescriptions or simply looking
                                for
                                peace
                                of mind, our system helps you make safer, more informed decisions about your health. <br>
                                Start
                                your path toward better health and safety, knowing that Mediste is with you every step of
                                the way.</p>
                                    ...
                                    <form method="POST" action="{{ route('profile.update') }}">
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <input type="text" name="blood_type" id="blood_type"
                                                            ...
                                                            required placeholder=" ">
                                                        <label class="form-control-label" for="blood_type">Blood
                                                            Type</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <select name="pregnancy_status" id="pregnancy_status"
                                                            class="form-control form-control-alternative" required
                                                            placeholder=" ">
                                                        ...
                                                        <label class="form-control-label" for="pregnancy_status">Pregnancy
                                                            Status</label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <input type="number" step="0.1" name="weight" id="weight"
                                                            class="form-control form-control-alternative"
                                                            value="{{ old('weight', $profile->weight ?? '') }}" required
                                                            placeholder=" ">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <input type="number" step="0.1" name="height" id="height"
                                                            class="form-control form-control-alternative"
                                                            value="{{ old('height', $profile->height ?? '') }}" required
                                                            placeholder=" ">
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="form-group">
                                                <input type="text" name="allergies" id="allergies"
                                                    class="form-control form-control-alternative"
                                                    value="{{ old('allergies', isset($profile->allergies) ? implode(',', $profile->allergies) : '') }}"
                                                    required placeholder=" ">
                                                <label class="form-control-label" for="allergies">Allergies
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="chronic_conditions" id="chronic_conditions"
                                                    class="form-control form-control-alternative"
                                                    value="{{ old('chronic_conditions', isset($profile->chronic_conditions) ? implode(',', $profile->chronic_conditions) : '') }}"
                                                    required placeholder=" ">
                                                <label class="form-control-label" for="chronic_conditions">Chronic
                                                    Conditions (comma-separated)</label>
                                            </div>

                                            <div class="form-group">
                                                <input type="text" name="medications" id="medications"
                                                    class="form-control form-control-alternative"
                                                    value="{{ old('medications', isset($profile->medications) ? implode(',', $profile->medications) : '') }}"
                                                    required placeholder=" ">
                                                <label class="form-control-label" for="medications">Medications
                                                    (comma-separated)</label>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="prescription" id="prescription"
                                                    class="form-control form-control-alternative"
                                                    value="{{ old('prescription', isset($profile->prescription) ? implode(',', $profile->prescription) : '') }}"
                                                    required placeholder=" ">
                                                <label class="form-control-label" for="prescription">Prescriptions
                                                    (comma-separated)</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="form-group">
                                                <textarea name="notes" id="notes" rows="4"
                                                    class="form-control form-control-alternative"
                                                    placeholder=" ">{{ old('notes', $profile->notes ?? '') }}</textarea>
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn px-5"
                                                style="background-color: #15616D; border-color: #15616D; color: white;">GET
                                                STARTED !</button>
                                        </div>
        ...
        <script>
            document.getElementById('gender').addEventListener('change', function () {
                ...
                if (this.value === 'male') {
                    pregnancyStatus.disabled = true;
                    pregnancyStatus.value = ''; // Reset the value
                } else {
                    pregnancyStatus.disabled = false;
                }
            });

            // Run on page load to handle pre-selected gender
        ...
        <form method="POST" action="{{ route('profile.update') }}">
            ...
            <div class="row row-cols-2 g-3">
                ...
                <div class="col">
                    ...
                    <input type="text" name="chronic_conditions" class="form-control" id="chronic_conditions"
                        value="{{ old('chronic_conditions', isset($profile->chronic_conditions) ? implode(',', $profile->chronic_conditions) : '') }}">
                </div>
